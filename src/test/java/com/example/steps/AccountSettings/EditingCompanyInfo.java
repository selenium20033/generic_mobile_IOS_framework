...
import com.example.pages.SalaryAnswers;
...
public class EditingCompanyInfo extends CommonMethods {
	...
	public void i_update_my_organization_section() throws InterruptedException {
		...
		act.myOrganizationNameTextbox.sendKeys("Thinkwhy");
...
//		minSync();
		...
		act.myOrganizationCountryDD.click();
		midSync();
		act.myOrganizationOption1.click();
		minSync();
		...
		act.myOrganizationWebsiteTextBox.sendKeys("www.thinkwhy.com");
		minSync();
		
		wait.until(ExpectedConditions.elementToBeClickable(act.myOrganizationEditConfirmationBtn));
		minSync();
		act.myOrganizationEditConfirmationBtn.click();
		minSync();
